                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a role="button" class="btn btn-info" href="ubah.php?id=<?php echo $d['id_karyawan']; ?>">UBAH</a>
                                        <a role="button" class="btn btn-danger" href="hapus.php?id=<?php echo $d['id_karyawan']; ?>">HAPUS</a>
                                    </td>
                                </tr>
                            <?php
                            }
